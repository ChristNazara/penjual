        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="kodepemasok" class="form-control" value="<?php echo $kodepemasok;?>" readonly="readonly">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="namapemasok" class="form-control" value="<?php echo $namapemasok?>">
